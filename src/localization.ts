...
function getLocal(data: any, args: any = {}) {
  let line = data[locale] || data['EN'] || data[Object.keys(data)[0]];
...
export const get = getLocal;
export const error = (data: any, args = {}) => {
  return {embed: {
    color: 11278626,
...
export const info = (data: any, args = {}) => {
  return {embed: {
    color: 4886754,
    description: getLocal(data, args),
  }};
  ...
  parser: {
    log: {
      ...
      mismatchHoles: {
        ...
        EN: 'Error: Holes number do not match for the answer \'{answer}\'. {question_holes} hole(s) in the question but ' +
            '{answer_opt} possibilities given in the answer for the following question block.\n{question}',
      },
